    ...
    try {
      ...
      if (res.ok) {
        setSubmittedRequests((prev) =>
          prev.map((req) => (req._id === id ? { ...req, status: 'completed' } : req))
        )
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-12">
        {/* Submit Form */}
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-2xl bg-white/90 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Input
                  ...
                  required
                  className="focus:ring-2 focus:ring-blue-500 border-gray-300 hover:border-gray-400"
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500 hover:border-gray-400"
                />
              </div>
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 h-12 text-lg font-medium"
              >
                {submitting ? (
                  <>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {submittedRequests.map((request, index) => (
                <Card
                  key={index}
                  className="border-0 shadow-md hover:shadow-xl transition-all rounded-xl overflow-hidden group"
                >
